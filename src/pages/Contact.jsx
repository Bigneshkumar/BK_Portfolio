...
export default function Contact() {
  ...
  return (
    <section className="contact-section" style={{ position: 'relative', zIndex: 1 }}>
      <motion.h1
      ...
      >
        ...
        <motion.button type="submit" className="contact-btn" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} style={{ fontFamily: "'Outfit', sans-serif" }}>
          🚀 Send Message
        </motion.button>
